...
public class DevelopmentDataSeeder {
    ...
    CommandLineRunner seedMorkBorgEquipment(
        ...
        return args -> {
            // ── Equipo (síncrono — Asdrubal se crea justo después) ───────────
    ...
    private List<Objeto> buildMbMiscItemList() {
        ...
        return List.of(
            ...
            buildInitialObject(BASE + ",ContenedorSinClase;3", "Mochila",       null, "mochila para 7 artículos de tamaño normal",  TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ContenedorSinClase;4", "Saco",          null, "saco para 10 prendas de tamaño normal",      TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ContenedorSinClase;5", "Cofre pequeño", null, "Caja resistente para guardar objetos valiosos.",                         TipoObjeto.MISCELANEO),
            ...
            buildInitialObject(BASE + ",ItemSinClase1;1",  "Cuerda",                null, "Cuerda de 30 pies. Útil para escalar o atar.",                             TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;2",  "Antorchas",             null, "Proporciona luz en la oscuridad durante varias horas.",                    TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;3",  "Farol",                 null, "Farol con aceite para Presencia +6 horas.",                               TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;4",  "Tira de magnesio",      null, "Arde con luz cegadora. Útil para iluminar o distraer.",                   TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;6",  "Aguja afilada",         null, "Pequeña pero letal. Útil para cerraduras o venenos.",                     TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;7",  "Botiquín",              null, "Detiene la hemorragia y la infección. Cura d6 PV.",                       TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;8",  "Lima de metal y ganzúas", null, "Herramientas para abrir cerraduras y limar barrotes.",                  TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;9",  "Trampa para osos",      null, "Presencia DR14 para detectar. Daño d8.",                                  TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;10", "Bomba",                 "1d10", "Botella sellada, daño d10.",                                            TipoObjeto.CONSUMIBLE),
            buildInitialObject(BASE + ",ItemSinClase1;11", "Botella de veneno rojo", null, "Resistencia CD12 o daño d10.",                                           TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase1;12", "Crucifijo de plata",    null, "Símbolo sagrado. Puede ahuyentar criaturas no muertas.",                  TipoObjeto.MISCELANEO),
            ...
            buildInitialObject(BASE + ",ItemSinClase2;1",  "Elixir de vida",            "1d6",  "Cura d6 PV y elimina la infección.",                                  TipoObjeto.CONSUMIBLE),
            // Perro y Monos → convertidos a habilidades (compañeros animales)

            buildInitialObject(BASE + ",ItemSinClase2;5",  "Perfume exquisito",         null,   "Perfume exquisito por valor de 25s.",                                 TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase2;6",  "Caja de herramientas",      null,   "10 clavos, tenazas, martillo, sierra pequeña y taladro.",            TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase2;7",  "Cadena pesada",             null,   "Cadena pesada de 15 pies.",                                           TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase2;8",  "Gancho de escalada",        null,   "Gancho resistente para escalar muros y acantilados.",                 TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase2;10", "Palanca",                   "1d4",  "Barra de metal para forzar puertas y mover obstáculos.",             TipoObjeto.ARMA),
            buildInitialObject(BASE + ",ItemSinClase2;11", "Manteca de cerdo",          null,   "Puede funcionar como 5 comidas en caso de necesidad.",               TipoObjeto.MISCELANEO),
            buildInitialObject(BASE + ",ItemSinClase2;12", "Tienda de campaña",         null,   "Refugio portátil para acampar en el exterior.",                      TipoObjeto.MISCELANEO),
            // ── Ítems especiales (equipo de clase / botín único) ──────────────────
            buildInitialObject(MB_SPECIAL_ITEM_CATALOG_TAG + ",DesertorColmilludo,DesertorItemIdx;1", "Máscara de monstruo arrugada", null,
                ...
                TipoObjeto.MISCELANEO),
            buildInitialObject(MB_SPECIAL_ITEM_CATALOG_TAG + ",DesertorColmilludo,DesertorItemIdx;3", "Dientes de mago", null,
                ...
                TipoObjeto.MISCELANEO),
            buildInitialObject(MB_SPECIAL_ITEM_CATALOG_TAG + ",ErmitanoEsoterico,ErmitanoEspecialidadIdx;2", "Un libro de sangre hirviendo", null,
    ...
    private List<Objeto> buildMbRealezaItemList() {
        return List.of(
            buildInitialObject(MB_REALEZA_ITEM_TAG + ",RealezaItemIdx;1", "La espada de tus antepasados", "d6+1",
                ...
                TipoObjeto.ARMA),
            buildInitialObject(MB_REALEZA_ITEM_TAG + ",RealezaItemIdx;5", "El regalo de piel de serpiente", "d4",
                ...
                TipoObjeto.ARMA),
            buildInitialObject(MB_REALEZA_ITEM_TAG + ",RealezaItemIdx;6", "¡Cuerno de los señores de Schleswig!", null,
    ...
    private List<Objeto> buildMbSacerdoteItemList() {
        return List.of(
            buildInitialObject(MB_SACERDOTE_ITEM_TAG + ",SacerdoteItemIdx;1", "Sagrado cayado del pastor", "2d4",
                ...
                TipoObjeto.ARMA),
            buildInitialObject(MB_SACERDOTE_ITEM_TAG + ",SacerdoteItemIdx;2", "Mitra robada", null,
                ...
                TipoObjeto.MISCELANEO),
            buildInitialObject(MB_SACERDOTE_ITEM_TAG + ",SacerdoteItemIdx;3", "Lista de pecados", null,
                ...
                TipoObjeto.MISCELANEO),
            buildInitialObject(MB_SACERDOTE_ITEM_TAG + ",SacerdoteItemIdx;4", "La Biblia blasfema de Nechrubel", null,
                ...
                TipoObjeto.MISCELANEO),
            buildInitialObject(MB_SACERDOTE_ITEM_TAG + ",SacerdoteItemIdx;5", "Piedras del Templo Perdido de Thel-Emas", null,
                ...
                TipoObjeto.MISCELANEO),
            buildInitialObject(MB_SACERDOTE_ITEM_TAG + ",SacerdoteItemIdx;666", "Crucifijo (Jesús invertido)", null,
    ...
    private List<Objeto> buildMbDecocciones() {
        return List.of(
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;1", "Veneno rojo",              null,    "Resistencia CD12 o −d10 PV.",                                                                                                         TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;2", "Vapores de Ezumiels",      null,    "Pasa una prueba CD14 o alucinaciones graves (y posiblemente divertidas) durante d4 horas.",                                            TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;3", "Estofado de rana sureña",  null,    "Vomita durante d4 horas; pasa una prueba CD14 o no puedes hacer nada más.",                                                           TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;4", "Elixir Vitalis",           "1d6",   "Cura d6 PV y detiene la infección. Puede crear hábito.",                                                                               TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;5", "Sopa de araña-búho",       null,    "Ver en la oscuridad y trepar por las paredes durante 30 minutos.",                                                                      TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;6", "Filtro de Fernor",         null,    "Aceite translúcido, debe aplicarse directamente en el ojo. Cura la infección y da +2 en las pruebas de Presencia durante d4 horas.",   TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;7", "Rapé enervante de Hyphos", null,    "¡Berserker! Dos ataques por asalto pero defiende con CD14. Dura una pelea. Debe ser inhalado; provoca estornudos.",                    TipoObjeto.CONSUMIBLE),
            buildInitialObject(MB_DECOCCION_TAG + ",DecoccIdx;8", "Veneno negro",             null,    "Resistencia CD14 o −d6 PV y cegado durante una hora.",                                                                                TipoObjeto.CONSUMIBLE)
        );
    }
    ...
    /** Añade '1' delante de dado suelto: "d4" → "1d4", "-d2" → "-1d2". */
    private String fixMBFormula(String formula) {
