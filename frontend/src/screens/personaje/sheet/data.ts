...
export const SKILL_ROWS = [
  ...
  {
    name: "Interpretacion",
    displayName: "Interpretacion",
    statName: "Carisma",
  },
  {
    name: "Intimidacion",
    displayName: "Intimidacion",
    statName: "Carisma",
  },
  {
    name: "Investigacion",
  ...
  { name: "Religion", displayName: "Religion", statName: "Inteligencia" },
...
export type DetailTab = "actions" | "spells" | "inventory";
