      ...
      >
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-stone-300">
              Elige el pasado de tu personaje. Según el trasfondo, aquí verás
        ...
        {selectedBackgroundId && isLoadingBackgroundInfo ? (
          <div className="mt-8 rounded-[24px] border border-stone-300/10 bg-black/20 p-8 text-center text-sm text-stone-300">
            Cargando información del trasfondo...
          </div>
        ) : null}
        ...
        {selectedBackground ? (
          <div className="mt-8 space-y-6">
            ...
            <div className={`${PANEL_CLASSES} p-6`}>
              ...
              <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,280px)_minmax(0,1fr)]">
                <div>
                  <label className="mb-2 block text-sm font-semibold text-amber-100/85">
                    Alineamiento
                  </label>
                  <div className="relative">
                    <select
          ...
          <div className="mt-8 rounded-[24px] border border-dashed border-stone-300/15 bg-black/20 p-8 text-center text-sm text-stone-300">
            Selecciona un trasfondo en el desplegable para ver su información y
            sus elecciones.
          </div>
        ) : null}
      </div>
